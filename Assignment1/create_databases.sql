...
-- used for IT2351 by Carlton Radivoyevitch, Fall 2020
-- *****************************************************

-- ********************************************
-- CREATE THE CRadOrderManagement DATABASE
-- *******************************************

-- create the database
DROP DATABASE IF EXISTS CradOrderManagement;
CREATE DATABASE CradOrderManagement;

-- select the database
USE CradOrderManagement;
